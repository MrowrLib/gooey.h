...
namespace gooey {
    ...
    struct UIPanelBase : public UIPanel {
        ...
        UIPanel*     add_vertical_panel(bool scaleAll, bool absolute) override { return nullptr; }
        UIPanel*     add_horizontal_panel(bool scaleAll, bool absolute) override { return nullptr; }
